...
Это рабочие типы первого среза, а не неизменяемый внешний контракт. Формат данных в HTTP API ещё не определён.
...
- Формат payload, result и error во внешнем HTTP API.
